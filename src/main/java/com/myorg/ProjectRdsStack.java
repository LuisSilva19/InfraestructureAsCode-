...
public class ProjectRdsStack extends Stack {
    public ProjectRdsStack(final Construct scope, final String id, final Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public ProjectRdsStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
